package com.skycoming.aidedlearningforjava.Activities;
...
import com.skycoming.aidedlearningforjava.Adapters.PagerAdapter;
import com.skycoming.aidedlearningforjava.Adapters.ZoomOutPageTransformer;
import com.skycoming.aidedlearningforjava.R;
...
public class MainActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        }else if (item.getItemId() == R.id.constructor){
        ...
        else if (item.getItemId() == R.id.numbers){
